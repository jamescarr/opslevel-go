...
type ComponentTypeInput struct {
	...
	Category          *Nullable[string]                       `json:"category,omitempty" yaml:"category,omitempty" example:"infrastructure"`      // The category of the component type, e.g. "default" or "infrastructure" (Optional)
